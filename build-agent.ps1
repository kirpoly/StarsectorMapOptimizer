...
[IO.File]::WriteAllText($bootstrapManifest, "Manifest-Version: 1.0`nImplementation-Title: Starsector Map Optimizer Bootstrap`nImplementation-Version: 0.4.0-exp7`n`n", (New-Object Text.UTF8Encoding($false)))
