...
Статус: `0.9.2` выпущена. Следующий цикл оптимизации экономики имеет версию `0.9.3`;
последующие совместимые итерации этого направления продолжают ряд `0.9.x`. Рабочая цель
