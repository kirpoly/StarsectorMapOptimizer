...
Статус: `0.9.3` выпущена. Следующая совместимая итерация оптимизации экономики имеет версию
`0.9.4`; последующие совместимые итерации этого направления продолжают ряд `0.9.x`. Рабочая цель
следующего архитектурного milestone — `0.10.0`; срок выпуска этим документом не задаётся.
