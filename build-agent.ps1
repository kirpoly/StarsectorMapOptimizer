...
[IO.File]::WriteAllText($bootstrapManifest, "Manifest-Version: 1.0`nImplementation-Title: Starsector Map Optimizer Bootstrap`nImplementation-Version: 0.3.0-exp3`n`n", (New-Object Text.UTF8Encoding($false)))
